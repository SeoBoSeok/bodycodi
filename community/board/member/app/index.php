...
<html>
<head>
	<script type="text/javascript" src="/static/js/controller/boardController.js?v=2.5"></script>
	<script type="text/javascript" src="/static/js/component/componentBoard.js?v=20211118"></script>
	<script type="text/javascript" src="/static/js/ui/uiCustomTable.js"></script>
	<link type="text/css" rel="stylesheet" href="/static/css/boardInfo.css" />
...
<aside class="ui-side">
	...
	<!-- 메인 -->
	<main>
		<section class="boardList" data-id="boardList">
			<div class="top">
				<div class="title">
					<div class="left">
						<h2>회원앱 커뮤니티</h2>
					...
					<div class="right">
						<button class="ui-button blue" data-event="create">게시글 등록</button>
					</div>
				</div>
			</div>
			<div class="middle">
