...
<head>
	...
	<script type="text/javascript" src="/static/js/component/componentNoticeBanner.js"></script>
...
<aside class="ui-side">
	...
	<!-- 메인 -->
	<main>
		<section class="noticeList" data-id="bannerList">
			<div class="top">
				<div class="title">
					<div class="left">
						<h2>배너공지</h2>
					...
					<div class="right">
						<button class="ui-button blue" data-event="create">배너공지 등록</button>
					</div>
				</div>
			</div>
			<div class="middle">
...
<script type="text/javascript">
function doReady() {
	componentNoticeBanner.list.open();
}
</script>
</html>
</html>
