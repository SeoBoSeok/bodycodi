...
<html>
<head>
	<script type="text/javascript" src="/static/js/controller/noticeController.js?v=20211110"></script>
	<script type="text/javascript" src="/static/js/component/componentNotice.js"></script>
...
<aside class="ui-side">
	...
	<!-- 메인 -->
	<main>
		<section class="noticeList" data-id="noticeList">
			<div class="top">
				<div class="title">
					<div class="left">
						<h2>공지사항</h2>
					...
					<div class="right">
						<button class="ui-button blue" data-event="create">공지사항 등록</button>
					</div>
				</div>
			</div>
			<div class="middle">
						...
						<table class="ui-table" data-id="ui-table">
							<thead>
								<tr>
									...
									<td>등록자</td>
									<td>발송대상</td>
									<td class="branchDisplay">발송지점</td>
									<td>시작/종료일</td>
									<td>등록일</td>
									<td>공개여부</td>
									<td>내용수정</td>
							...
							<tbody>
								<tr class="empty"><td colspan="6">데이터를 가져오는 중 입니다.</td></tr>
							</tbody>
						</table>
						<nav></nav>
					</div>
