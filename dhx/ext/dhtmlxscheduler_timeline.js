...
Scheduler.plugin(function(e) {
    e._temp_matrix_scope = function() {
        function t() {
            for (var t = e.get_visible_events(), a = [], n = 0; n < this.y_unit.length; n++)
                a[n] = [];
            var i;
            a[i] || (a[i] = []);
        ...
        function a(t, a, n) {
            ...
            if (o > 0) {
                ...
                s ? +_ > +h && a && (d = e._cols[l]) : (o = _ - h,
                n.first_hour || n.last_hour ? (o -= n._start_correction,
                0 > o && (o = 0),
                d = Math.round(o / r),
                d > e._cols[l] && (d = e._cols[l])) : d = Math.round(o / r))
            }
        ...
        function i(t) {
            if (e._ignores_detected)
                for (var a, n, i, r, s = 0; s < t.length; s++) {
                    for (r = t[s],
                    i = !1,
        ...
        function r(t) {
            ...
            if (t && "cell" != this.render) {
                ...
                for (var r = [], s = t.length, d = 0; s > d; d++) {
                    var _ = t[d];
                    _._inner = !1;
                    var o = this.round_position ? n.apply(this, [_.start_date, !1]) : _.start_date;
                    for (this.round_position ? n.apply(this, [_.end_date, !0]) : _.end_date; r.length; ) {
                        var l = r[r.length - 1];
                        if (!(l.end_date.valueOf() <= o.valueOf()))
                            break;
                        r.splice(r.length - 1, 1)
                    }
                    for (var c = !1, h = 0; h < r.length; h++) {
                        var u = r[h];
                        if (u.end_date.valueOf() <= o.valueOf()) {
                            c = !0,
                            _._sorder = u._sorder,
                            r.splice(h, 1),
                            _._inner = !0;
                    ...
                    if (r.length && (r[r.length - 1]._inner = !0),
                    !c)
                        if (r.length)
                            if (r.length <= r[r.length - 1]._sorder) {
                                if (r[r.length - 1]._sorder)
                                    for (var v = 0; v < r.length; v++) {
                                        for (var f = !1, g = 0; g < r.length; g++)
                                            if (r[g]._sorder == v) {
                                                f = !0;
                                                break
                                            }
                                ...
                                for (var p = r[0]._sorder, m = 1; m < r.length; m++)
                                    r[m]._sorder > p && (p = r[m]._sorder);
                                _._sorder = p + 1,
                                _._inner = !1
                            }
                        else
                            _._sorder = 0;
                    r.push(_),
                    r.length > (r.max_count || 0) ? (r.max_count = r.length,
                    _._count = r.length) : _._count = _._count ? _._count : 1;
                }
                for (var y = 0; y < t.length; y++)
                    t[y]._count = r.max_count;
                for (var x = 0; s > x; x++)
                    a += e.render_timeline_event.call(this, t[x], !1)
            }
            return a
        }
        function s(t) {
            ...
            for (var n = e._prepare_timeline_events(this), i = 0, s = 0; s < e._cols.length; s++)
                i += e._cols[s];
            var d = new Date
              , _ = e._cols.length - e._ignores_detected;
            d = (e.date.add(d, this.x_step * _, this.x_unit) - d - (this._start_correction + this._end_correction) * _) / i,
            this._step = d,
            this._summ = i;
            ...
            for (var s = 0; s < this.y_unit.length; s++) {
                var c = this._logic(this.render, this.y_unit[s], this);
                e._merge(c, {
                    height: this.dy
                }),
                this.section_autoheight && (this.y_unit.length * c.height < t.offsetHeight && (c.height = Math.max(c.height, Math.floor((t.offsetHeight - 1) / this.y_unit.length))),
                this._section_height[this.y_unit[s].key] = c.height),
                c.td_className || (c.td_className = "dhx_matrix_scell" + (e.templates[this.name + "_scaley_class"](this.y_unit[s].key, this.y_unit[s].label, this.y_unit[s]) ? " " + e.templates[this.name + "_scaley_class"](this.y_unit[s].key, this.y_unit[s].label, this.y_unit[s]) : "")),
                c.td_content || (c.td_content = e.templates[this.name + "_scale_label"](this.y_unit[s].key, this.y_unit[s].label, this.y_unit[s])),
                e._merge(c, {
                    tr_className: "",
                    style_height: "height:" + c.height + "px;",
                    style_width: "width:" + this.dx + "px;",
                    summ_width: "width:" + i + "px;",
                    table_className: ""
                });
                var h = r.call(this, n[s]);
                if (this.fit_events) {
                    var u = this._events_height[this.y_unit[s].key] || 0;
                    c.height = u > c.height ? u : c.height,
                    c.style_height = "height:" + c.height + "px;",
                    this._section_height[this.y_unit[s].key] = c.height
                }
                if (a += "<tr class='" + c.tr_className + "' style='" + c.style_height + "'><td class='" + c.td_className + "' style='" + c.style_width + " height:" + (c.height - 1) + "px;'>" + c.td_content + "</td>",
                "cell" == this.render)
                    for (var v = 0; v < e._cols.length; v++)
                        a += e._ignores[v] ? "<td></td>" : "<td class='dhx_matrix_cell " + e.templates[this.name + "_cell_class"](n[s][v], this._trace_x[v], this.y_unit[s]) + "' style='width:" + e._cols[v] + "px'><div style='width:auto'>" + e.templates[this.name + "_cell_value"](n[s][v], this._trace_x[v], this.y_unit[s]) + "</div></td>";
                else {
                    a += "<td><div style='" + c.summ_width + " " + c.style_height + " position:relative;' class='dhx_matrix_line'>",
                    a += h,
                    a += "<table class='" + c.table_className + "' cellpadding='0' cellspacing='0' style='" + c.summ_width + " " + c.style_height + "' >";
                    for (var v = 0; v < e._cols.length; v++)
                        a += e._ignores[v] ? "<td></td>" : "<td class='dhx_matrix_cell " + e.templates[this.name + "_cell_class"](n[s], this._trace_x[v], this.y_unit[s]) + "' style='width:" + e._cols[v] + "px'></td>";
                    a += "</table>",
                    a += "</div></td>"
                }
                a += "</tr>",
            ...
            this._scales = {};
            for (var f = t.firstChild.rows, g = null, s = 0, p = l.length; p > s; s++) {
                g = this.y_unit[s],
                o.push(l[s].height);
                var m = g.key
                  , y = this._scales[m] = e._isRender("cell") ? f[s] : f[s].childNodes[1].getElementsByTagName("div")[0];
                e.callEvent("onScaleAdd", [y, m])
            }
        }
        function d(t) {
            var a = e._min_date
            ...
            for (var i = (this.x_size + (t ? e._ignores_detected : 0),
            0), r = 0; +n > +a; )
                if (this._trace_x[r] = new Date(a),
                a = e.date.add(a, this.x_step, this.x_unit),
                e.date[this.x_unit + "_start"] && (a = e.date[this.x_unit + "_start"](a)),
                e._ignores[r] || i++,
                r++,
                t)
        ...
        function _(t) {
            ...
            s.style.width = r[0] + i + "px";
            for (var _ = e._min_date_timeline = e._min_date, l = e.config.preserve_scale_length, c = d.call(this, l), h = c.displayed, u = c.total, v = 0; u > v; v++)
                e._ignores[v] ? (e._cols[v] = 0,
                h++) : e._cols[v] = Math.floor(i / (h - v)),
                i -= e._cols[v],
                r[v + 1] = r[v] + e._cols[v];
            ...
            this.second_scale) {
                ...
                for (var M = 0; M < p.length; M++) {
                    var C = p[M]
                      , O = e.templates[this.name + "_second_scalex_class"](C)
                      , T = document.createElement("DIV");
                    T.className = "dhx_scale_bar dhx_second_scale_bar" + (O ? " " + O : ""),
                    e.set_xy(T, m[M] - 1, n - 3, y[M], 0),
                    T.innerHTML = e.templates[this.name + "_second_scale_date"](C),
                    D.appendChild(T)
                }
            }
            e.xy.scale_height = n,
            ...
            for (var L = 0; L < this._trace_x.length; L++)
                if (!e._ignores[L]) {
                    _ = this._trace_x[L],
                    e._render_x_header(L, r[L], _, t);
                    var S = e.templates[this.name + "_scalex_class"](_);
        ...
        function o(t, a, n) {
            switch (t) {
            case "hour":
                return a.getHours() != n.getHours() || o("day", a, n);
            case "day":
        ...
        function c(t) {
            ...
            t) {
                ...
                var a = e._min_date;
                _.call(this, e._els.dhx_cal_header[0]),
                s.call(this, e._els.dhx_cal_data[0]),
                e._min_date = a,
        ...
        function u(t, a, n) {
            if ("cell" == t.render) {
                ...
                e._tooltip) {
                    ...
                    s.className = "dhx_year_tooltip",
                    document.body.appendChild(s),
                    s.onclick = e._click.dhx_cal_data
                }
                for (var d = "", _ = 0; _ < r.length; _++) {
                    var o = r[_].color ? "background-color:" + r[_].color + ";" : ""
                      , l = r[_].textColor ? "color:" + r[_].textColor + ";" : "";
                    d += "<div class='dhx_tooltip_line' event_id='" + r[_].id + "' style='" + o + l + "'>",
                    d += "<div class='dhx_tooltip_date'>" + (r[_]._timed ? e.templates.event_date(r[_].start_date) : "") + "</div>",
                    d += "<div class='dhx_event_icon icon_details'>&nbsp;</div>",
                    d += e.templates[t.name + "_tooltip"](r[_].start_date, r[_].end_date, r[_]) + "</div>"
                }
        ...
        function v(t) {
            ...
            var r = n;
            if (e._ignores_detected)
                for (var s in e._ignores)
                    e._ignores[s] && r >= 1 * s && r++;
            return r
        }
        function f(t) {
            t = t || event;
        ...
        e.createTimelineView = function(t) {
                ...
                if ("minute" == t.x_unit || "hour" == t.x_unit) {
                    ...
                    if (d * s % 1440)
                        if (+e.date.date_part(new Date(a)) == +e.date.date_part(new Date(r)))
                            ...
                            var _ = 1440 / (s * d) - 1
                              , o = Math.round(_ * s);
                            n > 0 ? t.x_start = t.x_start - o : t.x_start = o + t.x_start
                        }
                }
                return r
            }
            ...
            e.date[t.name + "_start"] = function(a) {
                ...
                return r != s && i.setTime(i.getTime() + 6e4 * (s - r)),
                i
            }
            ,
            ...
            e["mouse_" + t.name] = function(a) {
                ...
                "move" == this._drag_mode && this._drag_id && this._drag_event) {
                    ...
                    void 0 === s._move_delta && (s._move_delta = (i.start_date - r) / 6e4,
                    this.config.preserve_length && a._ignores && (s._move_delta = this._get_real_event_length(i.start_date, r, t),
                    s._event_length = this._get_real_event_length(i.start_date, i.end_date, t))),
                    this.config.preserve_length && a._ignores) {
                        var d = (s._event_length,
                        this._get_fictional_event_length(r, s._move_delta, t, !0));
                        r = new Date(r - d)
                    } else
                        r = e.date.add(r, s._move_delta, "minute")
                }
                if ("resize" == this._drag_mode && i && (!this.config.timeline_swap_resize && this._drag_id && (this._drag_from_start && +r > +i.end_date ? this._drag_from_start = !1 : !this._drag_from_start && +r < +i.start_date && (this._drag_from_start = !0)),
                a.resize_from_start = this._drag_from_start,
                !this.config.timeline_swap_resize && this._drag_id && this._drag_from_start && +r >= +e.date.add(i.end_date, -e.config.time_step, "minute") && (r = e.date.add(i.end_date, -e.config.time_step, "minute"))),
                t.round_position)
                    switch (this._drag_mode) {
                    case "move":
                        this.config.preserve_length || (r = n.call(t, r, !1),
                ...
                t.round_position && "new-size" == this._drag_mode && r <= this._drag_start && (a.shift = e.date.add(this._drag_start, t.x_step, t.x_unit) - this._drag_start);
                var _ = this._is_pos_changed(this._drag_pos, a);
                return this._drag_pos && _ && (this._drag_event._dhx_changed = !0),
                _ || this._drag_pos.has_moved || (a.force_redraw = !1),
                a
            }
        }
        ,
        e._prepare_timeline_events = function(a) {
            var n = [];
            if ("cell" == a.render)
                n = t.call(a);
            else
                for (var i = e.get_visible_events(), r = a.order, s = 0; s < i.length; s++) {
                    var d = i[s]
                      , _ = d[a.y_property]
                      , o = a.order[_];
                    if (a.show_unassigned && !_) {
                        for (var l in r)
                            if (r.hasOwnProperty(l)) {
                                o = r[l],
                                n[o] || (n[o] = []);
                                var c = e._lame_copy({}, d);
                                c[a.y_property] = l,
                                n[o].push(c)
                            }
                    } else
        ...
        e._populate_timeline_rendered = function(t) {
            e._rendered = [];
            for (var a = t.getElementsByTagName("DIV"), n = 0; n < a.length; n++)
        ...
        e.render_timeline_event = function(t, n) {
            ...
            var l = e._get_timeline_event_y(t._sorder, _)
              , c = _ + l + 2;
            ...
            h = "dhx_cal_event_line " + (h || ""),
            t._no_drag_move && (h += " no_drag_move");
            var u = t.color ? "background:" + t.color + ";" : ""
              , v = t.textColor ? "color:" + t.textColor + ";" : ""
              , f = e.templates.event_bar_text(t.start_date, t.end_date, t)
              , g = '<div event_id="' + t.id + '" class="' + h + '" style="' + u + v + "position:absolute; top:" + l + "px; height: " + o + "px; left:" + s + "px; width:" + Math.max(0, d - s) + "px;" + (t._text_style || "") + '">';
            if (e.config.drag_resize && !e.config.readonly) {
                var p = "dhx_event_resize"
                  , m = "<div class='" + p + " " + p + "_start' style='height: " + o + "px;'></div>"
                  , y = "<div class='" + p + " " + p + "_end' style='height: " + o + "px;'></div>";
        ...
        e._locate_cell_timeline = function(t) {
            t = t || event;
            for (var a = t.target ? t.target : t.srcElement, n = {}, i = e.matrix[e._mode], r = e.getActionData(t), s = e._ignores, d = 0, _ = 0; _ < i._trace_x.length - 1 && !(+r.date < i._trace_x[_ + 1]); _++)
                s[_] || d++;
            n.x = 0 === d ? 0 : _,
            n.y = i.order[r.section];
            var o = e._isRender("cell") ? 1 : 0;
            n.src = i._scales[r.section] ? i._scales[r.section].getElementsByTagName("td")[_ + o] : null;
            for (var l = !1; 0 === n.x && "dhx_cal_data" != e._getClassName(a) && a.parentNode; ) {
        ...
        ;
        var p = e.dblclick_dhx_marked_timespan || function() {}
        ;
        e.dblclick_dhx_marked_timespan = function(t) {
            var a = e.matrix[e._mode];
            return a ? e.dblclick_dhx_matrix_cell(t) : p.apply(this, arguments)
        }
        ,
        ...
        e.attachEvent("onCellDblClick", function(t, a, n, i, r) {
            if (!this.config.readonly && ("dblclick" != r.type || this.config.dblclick_create)) {
                var s = e.matrix[e._mode]
                  , d = {};
                d.start_date = s._trace_x[t],
                d.end_date = s._trace_x[t + 1] ? s._trace_x[t + 1] : e.date.add(s._trace_x[t], s.x_step, s.x_unit),
                s._start_correction && (d.start_date = new Date(1 * d.start_date + s._start_correction)),
                s._end_correction && (d.end_date = new Date(d.end_date - s._end_correction)),
                d[s.y_property] = s.y_unit[a].key,
                e.addEventNow(d, null, r)
            }
        }),
        ...
        e._render_marked_timespan = function(t, n, i, r, s) {
            ...
            if (e.matrix && e.matrix[e._mode]) {
                ...
                if (i)
                    ...
                    var h = d.order;
                    if (c)
                        h.hasOwnProperty(c) && (o.push(c),
                        l.push(d._scales[c]));
                    else
                        for (var u in h)
                            h.hasOwnProperty(u) && (o.push(u),
                            l.push(d._scales[u]))
                }
                ...
                if (t.days > 6) {
                    ...
                    f.push.apply(f, e._get_dates_by_index(t.days));
                for (var p = t.zones, y = e._get_css_classes_by_config(t), x = 0; x < o.length; x++) {
                    n = l[x],
                    i = o[x];
                    for (var v = 0; v < f.length; v++)
                        for (var b = f[v], w = 0; w < p.length; w += 2) {
                            var k = p[w]
                              , E = p[w + 1]
                              , D = new Date(+b + 60 * k * 1e3)
                              , N = new Date(+b + 60 * E * 1e3);
                            if (N > r && s > D) {
                                ...
                                var C = a({
                                  ...
                                  , T = Math.max(1, O - C - 1)
                                  , L = d._section_height[i] - 1 || d.dy - 1;
                                M.style.cssText = "height: " + L + "px; left: " + C + "px; width: " + T + "px; top: 0;",
            ...
            return m.apply(e, [t, n, i])
        }
        ;
        var y = e._append_mark_now;
        e._append_mark_now = function(t, a) {
            ...
            return y.apply(e, [t, a])
        }
        ;
        var x = e._mark_timespans;
        ...
        e._on_scale_add_marker = function(t, a) {
            if (e.matrix && e.matrix[e._mode]) {
                ...
                if (i && e.matrix && e.matrix[e._mode])
                    for (var r = e._mode, s = e._min_date, d = e._max_date, _ = i.global, o = e.date.date_part(new Date(s)); d > o; o = e.date.add(o, 1, "day")) {
                        var l = +o
                          , c = o.getDay()
                          , h = []
                          , u = _[l] || _[c];
                        ...
                        i[r] && i[r][a]) {
                            ...
                            v.push.apply(v, e._get_configs_to_render(f)),
                            v.length && (h = v)
                        }
                        for (var g = 0; g < h.length; g++) {
                            var p = h[g]
                              , m = p.days;
                            7 > m ? (m = l,
                            n.push.apply(n, e._render_marked_timespan(p, t, a, o, e.date.add(o, 1, "day"))),
                            m = c) : n.push.apply(n, e._render_marked_timespan(p, t, a, o, e.date.add(o, 1, "day")))
                        }
                    }
                return n
            }
        ...
        e._resolve_timeline_section = function(e, t) {
            var a = 0
              , n = 0;
            for (a; a < this._colsS.heights.length && (n += this._colsS.heights[a],
            !(n > t.y)); a++)
                ;
        ...
        e._timeline_drag_date = function(t, a) {
            ...
            var c;
            if (_ >= r._trace_x.length)
                c = e.date.add(r._trace_x[r._trace_x.length - 1], r.x_step, r.x_unit),
                r._end_correction && (c = new Date(c - r._end_correction));
            else {
                var h = n * i * r._step + r._start_correction;
                c = new Date(+r._trace_x[_] + h)
            }
            return c
        }
        ,
