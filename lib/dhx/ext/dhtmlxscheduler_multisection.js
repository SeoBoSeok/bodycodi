        ...
        e._split_events = function(t) {
            ...
            if (n)
                for (var r = 0; r < t.length; r++) {
                    var s = this._get_event_sections(t[r]);
                    if (s.length > 1) {
                        for (var d = 0; d < s.length; d++)
                            if ("undefined" != typeof n.order[s[d]]) {
                                var _ = e._copy_event(t[r]);
                                _[i] = s[d],
                                a.push(_)
                            }
                    } else
        ...
        e.get_visible_events = function(e) {
            ...
            if (this._get_multisection_view()) {
                ...
                for (var a = 0; a < t.length; a++)
                    this.is_visible_events(t[a]) || (t.splice(a, 1),
                    a--);
        ...
        e._update_sections = function(t, a) {
            ...
            if (e.isMultisectionEvent(i)) {
                ...
                e._drag_event._orig_section != r.section) {
                    var s = n.order[r.section] - n.order[e._drag_event._orig_section];
                    if (s) {
                        ...
                        if (e.config.multisection_shift_all)
                            for (var l = 0; l < d.length; l++) {
                                var h = e._shift_sections(n, d[l], s);
                                if (null === h) {
                                    _ = d,
                                    o = !1;
                                    break
                            ...
                            for (var l = 0; l < d.length; l++) {
                                ...
                                if (d[l] == e._drag_event._orig_section) {
                                    var h = e._shift_sections(n, d[l], s);
                                    if (null === h) {
                                        _ = d,
                                        o = !1;
                        ...
                        o && (e._drag_event._orig_section = r.section),
                        i[e._get_section_property()] = _.join(e.config.section_delimiter)
                    }
                }
            } else
                a.apply(e, [t])
        ...
        e._get_blocked_zones = function(e, t, a, n, i) {
            if (t && this.config.multisection) {
                ...
                for (var s = [], d = 0; d < t.length; d++)
                    s = s.concat(r.apply(this, [e, t[d], a, n, i]));
                return s
            }
            return r.apply(this, arguments)
        }
        ;
        var s = e._check_sections_collision;
